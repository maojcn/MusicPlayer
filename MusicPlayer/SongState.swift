...
//  MusicPlayer
//
//  Created by Mao Jiacheng on 07.03.24.
//

import Foundation
import Combine

class SongState: ObservableObject {
    @Published var song: Song = songEntity
    @Published var currentIndext: Int = 0
}

let songEntity = Song(title: "起风了", lyrics: [
